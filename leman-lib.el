...
avatars, etc."
  ...
  (cl-labels ((relative-luminance (rgb)
    ...
    (let* ((id string)
      ...
      (when (< (contrast-ratio color-rgb contrast-with-rgb) leman-room-prism-minimum-contrast)
        (setf color-rgb (increase-contrast color-rgb contrast-with-rgb leman-room-prism-minimum-contrast
                                           (color-name-to-rgb
